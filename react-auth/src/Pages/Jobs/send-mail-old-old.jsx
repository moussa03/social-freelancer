...
const SendMail=()=>{
    ...
    const EchoConfig = {
      ...
      cluster: 'eu',
      authEndpoint: `http://127.0.0.1:8000/private-chat.${current}`,
      auth: {
          headers: {
  ...
  useEffect(() => {
    const  user_id=2;
    //   const channel = echo.channel('private.chat.'+user_id);
    
    //   echo.channel('private.chat.'+user_id).listen('.EmailRecrutor', (event) => {
    //     // const message = event// Update this line with the correct path to the message
    //     console.log('Notification received:', event);
    //     debugger;
      
    // });
    echo.private(`private-chat.${user_id}`)
        .listen('.EmailRecrutor', (e) => {
            console.log(e);
        });
...
<div class="sign_in_sec current send-mails-form" id="tab-1">
                      ...
                      <div class="col-lg-12 no-pdd">
                        ...
                        {/* <!--sn-field end--> */}
											...
											<div class="col-lg-12 no-pdd">
												<div class="sn-field">
													<input ref={email} name="password" placeholder="Password"/>
